    ...
    <html className={'h-full bg-gray-100'} lang={'en'}>
      <body className={'h-full'}>
        <div className={'min-h-full'}>
          ...
          <footer>
            <div className="mx-auto max-w-xl px-6 pb-12 lg:px-8">
              ...
              <div className="flex items-center justify-between mt-8">
                ...
                <ul className="flex space-x-6">
                  <li>
                    <a href={'https://github.com/asleepysheepy/nhl-tables'} className="text-gray-600 hover:text-gray-800">
                  ...
                  <li>
                    <a href={'https://twitter.com/a_sleepy_sheepy'} className="text-gray-600 hover:text-gray-800">
